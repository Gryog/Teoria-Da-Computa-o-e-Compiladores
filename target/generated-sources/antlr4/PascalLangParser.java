...
public class PascalLangParser extends Parser {
	...
	public final Chamada_procedimentoContext chamada_procedimento() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(139); identificador();
			setState(144);
			_la = _input.LA(1);
			if (_la==AP) {
				{
				setState(140); match(AP);
				setState(141); list_expressoes();
	...
	public final ExpressaoContext expressao() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(164); expressao_simples();
			setState(167);
			switch ( getInterpreter().adaptivePredict(_input,12,_ctx) ) {
			case 1:
				{
				setState(165); match(Relacao);
				setState(166); expressao_simples();
				}
				break;
			}
			}
	...
	public static final String _serializedATN =
		...
		"\4\2\17\17\32\33\4\2\20\21\34\34\3\2\3\4\3\2\23\27\u00ea\2\62\3\2\2\2"+
		"\48\3\2\2\2\6?\3\2\2\2\bI\3\2\2\2\nL\3\2\2\2\fY\3\2\2\2\16\\\3\2\2\2\20"+
		"d\3\2\2\2\22p\3\2\2\2\24v\3\2\2\2\26\u0086\3\2\2\2\30\u0088\3\2\2\2\32"+
